...
export const STICKER_KEYS = [
  ...
  'clock', 'coat', 'cocktail', 'coffee', 'compass', 'couch', 'crescent-moon', 'crown',
  'crutch', 'cut-of-meat', 'deer', 'dress-shoe', 'egg', 'film', 'fire', 'football',
  'fountain-pen', 'frog', 'gem', 'ghost', 'gi', 'glasses', 'globe', 'goblet', 'golf',
  'guitar', 'heart-pink', 'helmet', 'house-garden', 'inkwell', 'lantern', 'laptop',
  'luggage', 'medal', 'mic', 'money-bag', 'mountain-snow', 'movie-camera', 'musical-notes',
  'newspaper', 'oil-drum', 'open-book', 'owl', 'palm', 'palms-up', 'pine', 'popcorn',
  'postcard-arctic-circle', 'postcard-china', 'postcard-green-bay', 'postcard-india',
  'postcard-japan', 'postcard-lagos', 'postcard-madagascar', 'pushpin', 'rabbit', 'remote',
  'ring', 'rose', 'running-shoe', 'ship', 'skate', 'skis', 'slippers', 'snowflake',
