...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    clues: [
      ...
      { kind: 'standard', points: 500, question: `What time does Benja go to bed on a typical workday?`, answer: `4 or 5am`, stickers: [
          { art: 'owl', scale: 0.85 },
          { art: 'crescent-moon', scale: 1.45 },
          { art: 'slippers', scale: 1.6 },
        ] },
